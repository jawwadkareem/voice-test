(() => {
  ...
  const SILENCE_TIMEOUT_MS = 300; // Reduced for lower latency
  const POLL_INTERVAL_MS = 50; // Reduced for faster polling
  const MIME_TYPE = "audio/webm;codecs=opus"; // Use opus for efficiency
